...
const LOCALES = {
  ...
  click_to_upload: ['在此处上传商品图片', 'Upload product image here', 'Sube la imagen aquí', 'Envie a imagem aqui'],
  select_product_hint: ['点击上方分类按钮选择品类，再点击商品', 'Click a category above, then select a product', 'Selecciona una categoría y luego un producto', 'Selecione uma categoria e depois um produto'],
  ...
  login_title: ['登录', 'Login', 'Iniciar Sesión', 'Entrar'],
  register_title: ['注册', 'Register', 'Registrarse', 'Registrar'],
  login_btn: ['登录', 'Login', 'Iniciar Sesión', 'Entrar'],
  register_btn: ['注册', 'Register', 'Registrarse', 'Registrar'],
  login_switch: ['没有账号？', "Don't have an account?", '¿No tienes cuenta?', 'Não tem conta?'],
  register_switch: ['已有账号？', 'Already have an account?', '¿Ya tienes cuenta?', 'Já tem conta?'],
  invite_label: ['邀请码 *', 'Invite Code *', 'Código de Invitación *', 'Código de Convite *'],
  invite_hint: ['（联系客服获取）', '(ask customer service)', '(consultar al servicio)', '(consulte o atendimento)'],
  invite_placeholder: ['请联系客服获取邀请码', 'Ask customer service for invite code', 'Solicite el código al servicio', 'Solicite o código ao atendimento'],
  invite_error: ['邀请码无效，请联系客服获取正确的邀请码', 'Invalid code, please contact customer service', 'Código inválido, contacte al servicio', 'Código inválido, contate o atendimento'],
  nickname_label: ['昵称', 'Nickname', 'Apodo', 'Apelido'],
  nickname_placeholder: ['你的昵称', 'Your nickname', 'Tu apodo', 'Seu apelido'],
  phone_label: ['手机号', 'Phone', 'Teléfono', 'Telefone'],
  phone_placeholder: ['手机号码', 'Phone number', 'Número de teléfono', 'Número de telefone'],
  password_label: ['密码', 'Password', 'Contraseña', 'Senha'],
  password_placeholder: ['密码（至少4位）', 'Password (min 4 chars)', 'Contraseña (mín 4 caracteres)', 'Senha (mín 4 caracteres)'],
  processing: ['处理中...', 'Processing...', 'Procesando...', 'Processando...'],

  search_placeholder: ['🔍 搜索商品名称或分类...', '🔍 Search product or category...', '🔍 Buscar producto o categoría...', '🔍 Buscar produto ou categoria...'],
  search_no_result: ['没有找到匹配的商品', 'No products found', 'No se encontraron productos', 'Nenhum produto encontrado'],

  trust_secure: ['🔒 安全支付', '🔒 Secure Payment', '🔒 Pago Seguro', '🔒 Pagamento Seguro'],
  trust_shipping: ['🚚 全球发货', '🚚 Worldwide Shipping', '🚚 Envío Mundial', '🚚 Envio Mundial'],
  trust_support: ['💬 在线客服', '💬 Customer Support', '💬 Soporte al Cliente', '💬 Suporte ao Cliente'],
  trust_quality: ['⭐ 品质保证', '⭐ Quality Guaranteed', '⭐ Calidad Garantizada', '⭐ Qualidade Garantida'],
  trust_tip: ['下单前请先浏览商品图片，选好后回到此页提交订单', 'Browse product images first, then return here to order', 'Vea las imágenes primero, luego vuelva aquí para pedir', 'Veja as imagens primeiro, depois volte aqui para pedir'],
  footer_rights: ['© 2026 Jersey Order. All rights reserved.', '© 2026 Jersey Order. All rights reserved.', '© 2026 Jersey Order. Todos los derechos reservados.', '© 2026 Jersey Order. Todos os direitos reservados.'],
  footer_contact: ['联系客服', 'Contact Us', 'Contáctenos', 'Fale Conosco'],
  footer_orders: ['我的订单', 'My Orders', 'Mis Pedidos', 'Meus Pedidos'],
  footer_images: ['商品图片', 'Product Images', 'Imágenes', 'Imagens'],

  patch_left: ['左袖', 'Left Sleeve', 'Manga Izquierda', 'Manga Esquerda'],
  patch_right: ['右袖', 'Right Sleeve', 'Manga Derecha', 'Manga Direita'],
  patch_both: ['左袖+右袖', 'Both Sleeves', 'Ambas Mangas', 'Ambas Mangas'],
  patch_count: ['{n}补丁', '{n} Patches', '{n} Parches', '{n} Remendos'],
  ...
  // ---- 无标价商品 ----
  other_notice: ['⚠️ 此商品没有标价。请上传商品图片后联系客服获取价格，再填入下方价格栏。', '⚠️ No price set. Upload an image, contact us for the price, then enter it below.', '⚠️ Sin precio. Sube una imagen, consulta el precio y escríbelo.', '⚠️ Sem preço. Envie uma imagem, consulte o preço e insira abaixo.'],
  other_price_label: ['价格 € *', 'Price € *', 'Precio € *', 'Preço € *'],
  other_price_placeholder: ['请向客服询问价格，输入', 'Ask customer service for price', 'Consultar precio al servicio', 'Consulte o preço com o atendimento'],
  other_note_label: ['备注', 'Notes', 'Notas', 'Observações'],
  other_note_placeholder: ['请备注你的商品，如球鞋请备注尺寸', 'Describe your item (e.g. shoe size)', 'Describe tu artículo (ej. talla de zapato)', 'Descreva seu item (ex. tamanho do sapato)'],
